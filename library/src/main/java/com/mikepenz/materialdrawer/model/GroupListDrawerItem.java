...
public class GroupListDrawerItem implements IDrawerItem, Nameable<GroupListDrawerItem>, Iconable<GroupListDrawerItem>, Badgeable<GroupListDrawerItem>, Checkable<GroupListDrawerItem>, Tagable<GroupListDrawerItem> {
    ...
    private ArrayList<IDrawerItem> childItems = new ArrayList<>();
    public GroupListDrawerItem withIdentifier(int identifier) {
        this.identifier = identifier;
        return this;
    }
    public GroupListDrawerItem withIcon(Drawable icon) {
        this.icon = icon;
        return this;
    }
    public GroupListDrawerItem withIcon(int iconRes) {
        this.iconRes = iconRes;
        return this;
    }
    public GroupListDrawerItem withIcon(IIcon iicon) {
        this.iicon = iicon;
        return this;
    }
    public GroupListDrawerItem withItem(IDrawerItem item) {
        this.childItems.add(item);
        return this;
    }
    public GroupListDrawerItem withSelectedIcon(Drawable selectedIcon) {
        this.selectedIcon = selectedIcon;
        return this;
    }
    public GroupListDrawerItem withSelectedIcon(int selectedIconRes) {
        this.selectedIconRes = selectedIconRes;
        return this;
    }
    public GroupListDrawerItem withName(String name) {
        this.name = name;
        return this;
    }
    public GroupListDrawerItem withName(int nameRes) {
        this.nameRes = nameRes;
        return this;
    }
    public GroupListDrawerItem withBadge(String badge) {
        this.badge = badge;
        return this;
    }
    public GroupListDrawerItem withTag(Object object) {
        this.tag = object;
        return this;
    }
    public GroupListDrawerItem withCheckable(boolean checkable) {
        this.checkable = checkable;
        return this;
    }
    public GroupListDrawerItem setEnabled(boolean enabled) {
        this.enabled = enabled;
        return this;
    }
    public GroupListDrawerItem withSelectedColor(int selectedColor) {
        this.selectedColor = selectedColor;
        return this;
    }
    public GroupListDrawerItem withSelectedColorRes(int selectedColorRes) {
        this.selectedColorRes = selectedColorRes;
        return this;
    }
    public GroupListDrawerItem withTextColor(int textColor) {
        this.textColor = textColor;
        return this;
    }
    public GroupListDrawerItem withTextColorRes(int textColorRes) {
        this.textColorRes = textColorRes;
        return this;
    }
    public GroupListDrawerItem withSelectedTextColor(int selectedTextColor) {
        this.selectedTextColor = selectedTextColor;
        return this;
    }
    public GroupListDrawerItem withSelectedTextColorRes(int selectedColorRes) {
        this.selectedTextColorRes = selectedColorRes;
        return this;
    }
    public GroupListDrawerItem withDisabledColor(int disabledColor) {
        this.disabledColor = disabledColor;
        return this;
    }
    public GroupListDrawerItem withDisabledColorRes(int disabledColorRes) {
    ...
    public IDrawerItem getChildAt(int position){
