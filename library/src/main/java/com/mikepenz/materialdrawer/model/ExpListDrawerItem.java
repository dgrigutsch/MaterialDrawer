...
public class ExpListDrawerItem implements IDrawerItem, Nameable<ExpListDrawerItem>, Iconable<ExpListDrawerItem>, Badgeable<ExpListDrawerItem>, Checkable<ExpListDrawerItem>, Tagable<ExpListDrawerItem> {
    ...
    public ExpListDrawerItem withIdentifier(int identifier) {
        this.identifier = identifier;
        return this;
    }
    public ExpListDrawerItem withIcon(Drawable icon) {
        this.icon = icon;
        return this;
    }
    public ExpListDrawerItem withIcon(int iconRes) {
        this.iconRes = iconRes;
        return this;
    }
    public ExpListDrawerItem withIcon(IIcon iicon) {
        this.iicon = iicon;
        return this;
    }
    public ExpListDrawerItem withItem(IDrawerItem item) {
        this.childItems.add(item);
        return this;
    }
    public ExpListDrawerItem withSelectedIcon(Drawable selectedIcon) {
        this.selectedIcon = selectedIcon;
        return this;
    }
    public ExpListDrawerItem withSelectedIcon(int selectedIconRes) {
        this.selectedIconRes = selectedIconRes;
        return this;
    }
    public ExpListDrawerItem withName(String name) {
        this.name = name;
        return this;
    }
    public ExpListDrawerItem withName(int nameRes) {
        this.nameRes = nameRes;
        return this;
    }
    public ExpListDrawerItem withBadge(String badge) {
        this.badge = badge;
        return this;
    }
    public ExpListDrawerItem withTag(Object object) {
        this.tag = object;
        return this;
    }
    public ExpListDrawerItem withCheckable(boolean checkable) {
        this.checkable = checkable;
        return this;
    }
    public ExpListDrawerItem setEnabled(boolean enabled) {
        this.enabled = enabled;
        return this;
    }
    public ExpListDrawerItem withSelectedColor(int selectedColor) {
        this.selectedColor = selectedColor;
        return this;
    }
    public ExpListDrawerItem withSelectedColorRes(int selectedColorRes) {
        this.selectedColorRes = selectedColorRes;
        return this;
    }
    public ExpListDrawerItem withTextColor(int textColor) {
        this.textColor = textColor;
        return this;
    }
    public ExpListDrawerItem withTextColorRes(int textColorRes) {
        this.textColorRes = textColorRes;
        return this;
    }
    public ExpListDrawerItem withSelectedTextColor(int selectedTextColor) {
        this.selectedTextColor = selectedTextColor;
        return this;
    }
    public ExpListDrawerItem withSelectedTextColorRes(int selectedColorRes) {
        this.selectedTextColorRes = selectedColorRes;
        return this;
    }
    public ExpListDrawerItem withDisabledColor(int disabledColor) {
        this.disabledColor = disabledColor;
        return this;
    }
    public ExpListDrawerItem withDisabledColorRes(int disabledColorRes) {
    ...
    public int getLayoutRes() {
        return R.layout.drawer_item_exp_list;
    }
    @Override
